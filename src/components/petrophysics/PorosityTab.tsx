              ...
              {(['sandstone', 'limestone', 'dolomite'] as const).map(lith => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setPorosityInp({
                      ...porosityInp,
                      lithology: lith, rhoMatrix: rho, dtMatrix: dt,
                      rhoFluid: porosityInp.rhoFluid ?? 1.0,
                      dtFluid: porosityInp.dtFluid ?? 189,
                      vshale: porosityInp.vshale ?? 0.1,
                      dtShale: porosityInp.dtShale ?? 100,
                      dphiShale: porosityInp.dphiShale ?? 0.15,
                      nphiShale: porosityInp.nphiShale ?? 0.3,
                      applyShaleCorrection: porosityInp.applyShaleCorrection ?? false
                    });
                  }}
                  className={cn(
